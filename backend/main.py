...
def analyze(req: AnalyzeRequest):
    """
    ENHANCED analyze endpoint - uses BOTH registry AND best practices parsing.
    
    Flow:
    1. Categorize prompt → get techniques
    2. Get best practices for those techniques
    3. Parse best practices → extract nodes, patterns, instructions
    4. Use registry generator → get workflow-specific nodes
