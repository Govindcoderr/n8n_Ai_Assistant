...
#     name: str = Field(
#         ..., description="Descriptive name explaining the node purpose"
#     )
#     connectionParametersReasoning: str = Field(
#         ...,
#         description=(
#             "REQUIRED: Reasoning for connection parameters. "
#             "Explain dynamic inputs, modes, operations, etc."
#         ),
#     )
#     connectionParameters: Dict[str, Any] = Field(
#         default_factory=dict,
#         description=(
#             "Only parameters that affect node connections. "
#             "Use {} if none are required."
#         ),
#     )
...
#     @tool(
#         name=tool_base.toolName,
#         description=(
#             "Add a node to the workflow canvas. "
#             "Always provide a descriptive name and explicitly set "
#             "connection-affecting parameters. "
