...
class HumanInTheLoopBestPractices(BestPracticesDocument):
    technique = WorkflowTechnique.HUMAN_IN_THE_LOOP
    version = "1.0.0"

    def __init__(self) -> None:
        self._documentation = """# Best Practices: Human-in-the-Loop Workflows
