...
class DataTransformationBestPractices(BestPracticesDocument):
    technique = WorkflowTechnique.DATA_TRANSFORMATION
    version = "1.0.0"

    def __init__(self) -> None:
        self._documentation = """# Best Practices: Data Transformation Workflows 
