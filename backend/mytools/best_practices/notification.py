...
class NotificationBestPractices(BestPracticesDocument):
    technique = WorkflowTechnique.NOTIFICATION
    version = "1.0.0"

    def __init__(self) -> None:
        self._documentation = """# Best Practices: Notification Workflows 
