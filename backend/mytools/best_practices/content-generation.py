...
class ContentGenerationBestPractices(BestPracticesDocument):
    technique = WorkflowTechnique.CONTENT_GENERATION
    version = "1.0.0"

    def __init__(self) -> None:
        self._documentation = """# Best Practices: Content Generation Workflows
