...
class ChatbotBestPractices(BestPracticesDocument):
    technique = WorkflowTechnique.CHATBOT
    version = "1.0.0"

    def __init__(self) -> None:
        self._documentation = """# Best Practices: Chatbot Workflows
...
e same chat node type as used for response. If Telegram has been requested trigger the chatbot via telegram AND
respond via telegram - do not mix chatbot interf
For the chatbot always use thaces.
